/**
 * Valibot schema for Jira comment command arguments
 */
...
/**
 * Schema for comment command arguments
 *
 ...
 */
export const CommentArgsSchema = v.object({
...
export type CommentArgs = v.InferOutput<typeof CommentArgsSchema>;
